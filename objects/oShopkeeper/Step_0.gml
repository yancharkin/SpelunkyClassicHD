...
if ((x > __view_get( e__VW.XView, 0 )-20 and x < __view_get( e__VW.XView, 0 )+__view_get( e__VW.WView, 0 )+4 and
	    ...
	    if (oPlayer1.holdItem > 0)
	    {
	        ...
	        if (item.cost > 0)
	        {
	            ...
	            if (global.touchControlsVisibility > 0) {
	                ...
	                message2[1] = scrGetKey(global.keyPayVal);
	            }
	            message2[2] = " TO PURCHASE.";
	...
	if (status == IDLE)
	{
	    ...
	    {
	        if (style == tr("BOMB")) message1 = ["WELCOME TO ", scrGetName(),  "'S BOMB SHOP!"];
	        else if (style == "Weapon") message1 = ["WELCOME TO ",  scrGetName(), "'S ARMORY!"];
	        else if (style == "Clothing") message1 = ["WELCOME TO ", scrGetName() , "'S CLOTHING SHOP!"];
	        else if (style == "Rare") message1 = ["WELCOME TO ", scrGetName(), "'S SPECIALTY SHOP!"];
	        else if (style == "Craps") message1 = ["WELCOME TO ",  scrGetName(), "'S DICE HOUSE!"];
	        else if (style == "Kissing") message1 = ["WELCOME TO ", scrGetName(), "'S KISSING PARLOR!"];
	        else if (style == "Ankh") message1 = ["I HAVE SOMETHING SPECIAL..."];
	        else message1 = ["WELCOME TO ", scrGetName(), "'S SUPPLY SHOP!"];
	        if (style == "Craps")
	        {
	            message2[0] = "PRESS ";
	            if (global.touchControlsVisibility > 0) {
	    ...
	    if (style == "Craps")
	    {
	        ...
	        if (global.diceRolled)
	        {
	            if (global.diceValue == 7)
	            {
	                ...
	                message1 = "YOU ROLLED A SEVEN!";
	                message2 = "YOU WIN A PRIZE!";
	                oPlayer1.bet = 0;
	                with oItem
	                {
	                    if (inDiceHouse)
	            ...
	            {
	                if (isRealLevel()) global.diceGamesWon += 1;
	                message1 = ["YOU ROLLED A ", string(global.diceValue), "!"];
	            ...
	            else if (global.diceValue < 7)
	            {
	                ...
	                message1 = ["YOU ROLLED A ", string(global.diceValue), "!"];
	                message2 = ["I'M SORRY, BUT YOU LOSE!"];
	                oPlayer1.bet = 0;
	            }
	            global.diceRolled = false;
