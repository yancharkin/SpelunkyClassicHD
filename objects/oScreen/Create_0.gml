...
room_set_view(rHighscores,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rSun,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rMoon,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rStars,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
...
room_set_view(rTransition1,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rTransition1x,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rTransition2,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rTransition2x,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rTransition3,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rTransition3x,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rTransition4,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rEnd,0,true,0,0,w,h,0,0,w,h,0,0,0,0,oPDummy);
room_set_view(rEnd2,0,true,-2*global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rEnd3,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
room_set_view(rEndCustom,0,true,-global.room_offset,0,w,h,0,0,w,h,0,0,0,0,noone);
